    ...
    <div className="min-h-screen bg-linear-to-br from-emerald-50 to-cyan-50 flex">
      <div className="hidden w-1/2 lg:flex flex-col justify-between bg-linear-to-br from-emerald-600 to-cyan-600 p-12 text-white">
        <div className="flex flex-col items-start">
          <img src="/logo.png" alt="Silsilah Keluarga" className="h-24 w-24 mb-6" />
        </div>
        ...
        <div className="max-w-lg">
          ...
          <p className="text-emerald-100 text-lg leading-relaxed font-medium">
            Menghubungkan Generasi,<br />
            Menjaga Warisan Keluarga Kita
          </p>
        </div>
        
        <div className="text-emerald-200 text-sm font-medium">
          <p>Dibuat oleh <a href="https://zamili.dev" target="_blank" rel="noopener noreferrer" className="underline hover:text-white font-semibold">Nestor Zamili</a></p>
          <p className="mt-1">© 2026 Silsilah Keluarga. Hak cipta dilindungi.</p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-3">
              <img src="/logo.png" alt="Silsilah Keluarga" className="h-20 w-20" />
